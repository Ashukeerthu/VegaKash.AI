...
class TestCalculateSummaryEndpoint:
    ...
    def test_calculate_summary_valid_input(self, client, sample_financial_input):
    ...
    def test_calculate_summary_minimal_input(self, client, minimal_financial_input):
    ...
    def test_calculate_summary_invalid_input(self, client):
...
class TestRateLimiting:
    ...
    def test_rate_limit_headers(self, client, minimal_financial_input):
