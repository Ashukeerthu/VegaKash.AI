...
export const calculatorRoutes = [
  ...
  {
    path: '/calculators/loan-payment-us',
  ...
  {
    path: '/calculators/credit-card-payoff-us',
  ...
  {
    path: '/calculators/401k-retirement-us',
  ...
  {
    path: '/calculators/savings-growth-us',
  ...
  {
    path: '/calculators/mortgage-affordability-uk',
  ...
  {
    path: '/calculators/savings-interest-uk',
    element: SavingsInterestCalculatorUK,
    title: 'UK Savings Account Interest Calculator',
